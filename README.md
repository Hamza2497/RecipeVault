...
RecipeVault lets users save, organize, and discover recipes — with Gemini AI generating smart suggestions based on ingredients on hand. Built as a full-stack portfolio project to demonstrate end-to-end ownership from REST API design to cloud deployment.
