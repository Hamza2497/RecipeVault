 ...
 * This is the registration page where new users can create a RecipeVault account. They enter
 * their username, email, and password. When they click "Register", it sends their information
 * to the backend server. If successful, they get a token and are logged in automatically,
 * then redirected to the home page. If it fails, they see an error message.
 *
 * Key concepts for beginners:
 * - useState: A React hook that lets components remember things (like form values and errors)
 * - useNavigate: A React hook that lets us change the page after registration succeeds
 ...
 *
 * Flow:
 * 1. User types their username, email, and password
 * 2. User clicks the Register button
 * 3. We send their information to the backend
 * 4. Backend creates the account and sends back a token
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-8">
            Join RecipeVault and start sharing recipes
          </p>
